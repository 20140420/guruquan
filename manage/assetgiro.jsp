...
<table>
    <tr>
          <td colspan="6" align="left">转账管理</td>
        </tr>
        <tr>
          <th colspan="6" align="left">转账设置</th>
          </tr>
        <tr>
          <td>限额：</td>
          ...
          <td>兑换汇率：</td>
          <td class="col4"><input type="text" placeholder="1：1" ></td>
          </tr>
        <tr>
          <td>附加比率：</td>
          <td class="col4"><input type="text" placeholder="0%" ></td>
          <td>&nbsp;</td>
          <td class="col4">&nbsp;</td>
          <td>&nbsp;</td>
          <td class="col4">&nbsp;</td>
        ...
        <tr>
          <th colspan="2" align="left">转账记录</th>
